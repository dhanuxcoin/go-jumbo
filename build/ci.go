...
import (
	...
	"github.com/dhanuxcoin/go-jumbo/crypto/signify"
	"github.com/dhanuxcoin/go-jumbo/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/dhanuxcoin/go-jumbo/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/dhanuxcoin/go-jumbo/mobile")
