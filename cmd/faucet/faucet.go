...
import (
	...
	"github.com/dhanuxcoin/go-jumbo/accounts/abi"
	"github.com/dhanuxcoin/go-jumbo/accounts/keystore"
	"github.com/dhanuxcoin/go-jumbo/cmd/utils"
	...
	"github.com/dhanuxcoin/go-jumbo/ethclient"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/dhanuxcoin/go-jumbo/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
